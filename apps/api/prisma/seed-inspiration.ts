...
const ITEMS = [
  // ── Performances ──────────────────────────────────────────────────────────
  {
    ...
    tags: ['igbo', 'atilogwu', 'traditional dance', 'entrance', 'cultural', 'acrobatic', 'ogene', 'nigerian', 'group dance'],
    location: 'Ottawa, ON',
    priceRangeFrom: 500,
    priceRangeTo: 1500,
    isAdminCurated: true,
  },
  {
    ...
    category: InspirationCategory.PERFORMANCE,
    tags: ['yoruba', 'agbo', 'talking drum', 'aso-oke', 'wedding dance', 'traditional', 'sekere', 'nigerian', 'cultural performance'],
    location: 'Ottawa, ON',
    priceRangeFrom: 600,
    priceRangeTo: 2000,
    isAdminCurated: true,
  },
  {
    ...
    category: InspirationCategory.PERFORMANCE,
    tags: ['hausa', 'durbar', 'procession', 'northern nigeria', 'kakaki', 'royal', 'ceremonial', 'entrance', 'cultural'],
    location: 'Ottawa, ON',
    priceRangeFrom: 1000,
    priceRangeTo: 3000,
    isAdminCurated: true,
  },
  {
    ...
    tags: ['live band', 'afrobeats', 'highlife', 'afro-fusion', 'juju', 'fela kuti', 'entertainment', 'dancing', 'nigerian music'],
    location: 'Ottawa, ON',
    priceRangeFrom: 2000,
    priceRangeTo: 6000,
    isAdminCurated: true,
  },
  {
    ...
    category: InspirationCategory.PERFORMANCE,
    tags: ['oriki', 'praise singer', 'yoruba', 'tradition', 'family', 'chanting', 'talking drum', 'ceremony', 'personal'],
    location: 'Ottawa, ON',
    priceRangeFrom: 300,
    priceRangeTo: 800,
    isAdminCurated: true,
  ...
  // ── Venues ────────────────────────────────────────────────────────────────
  {
    ...
    tags: ['high ceilings', 'ballroom', 'grand', 'large venue', 'vaulted', 'stage', 'dance floor', 'reception', 'ottawa'],
    location: 'Ottawa, ON',
    priceRangeFrom: 5000,
    priceRangeTo: 15000,
    isAdminCurated: true,
  },
  {
    ...
    category: InspirationCategory.VENUE,
    tags: ['heritage', 'exposed brick', 'timber beams', 'rustic', 'historic', 'intimate', 'character', 'warm lighting', 'ottawa'],
    location: 'Ottawa, ON',
    priceRangeFrom: 3000,
    priceRangeTo: 8000,
    isAdminCurated: true,
  },
  {
    ...
    category: InspirationCategory.VENUE,
    tags: ['outdoor', 'garden', 'pavilion', 'nature', 'summer', 'greenery', 'ceremony', 'traditional', 'lawn', 'pond', 'ottawa'],
  ...
  // ── Decor ─────────────────────────────────────────────────────────────────
  {
    ...
    tags: ['gold', 'emerald', 'green', 'luxury', 'tablescapes', 'centerpieces', 'floral', 'candelabra', 'opulent', 'reception decor'],
    isAdminCurated: true,
  },
  {
    ...
    category: InspirationCategory.DECOR,
    tags: ['kente', 'fabric', 'draping', 'ghanaian', 'african', 'cultural', 'colorful', 'textile', 'installation', 'ceiling'],
    isAdminCurated: true,
  },
  {
    ...
    category: InspirationCategory.DECOR,
    tags: ['white wedding', 'floral arch', 'ceremony', 'orchids', 'peonies', 'eucalyptus', 'aisle', 'church', 'romantic', 'classic'],
    isAdminCurated: true,
  },
  {
    ...
    category: InspirationCategory.DECOR,
    tags: ['aso-oke', 'canopy', 'traditional altar', 'yoruba', 'igbo', 'edo', 'carved wood', 'palm fronds', 'brass', 'ceremony setup'],
    isAdminCurated: true,
  },
  ...
  // ── Fashion ───────────────────────────────────────────────────────────────
  {
    ...
    tags: ['iro', 'buba', 'george wrapper', 'gele', 'bridal', 'traditional', 'nigerian', 'custom', 'embroidered', 'wedding outfit'],
    location: 'Ottawa, ON',
    priceRangeFrom: 800,
    priceRangeTo: 3000,
    isAdminCurated: true,
  },
  {
    ...
    category: InspirationCategory.FASHION,
    tags: ['agbada', 'aso-oke', 'groom', 'embroidery', 'traditional', 'yoruba', 'sokoto', 'buba', 'regal', 'wedding', 'mens fashion'],
    location: 'Ottawa, ON',
    priceRangeFrom: 600,
    priceRangeTo: 2500,
    isAdminCurated: true,
  ...
  // ── Food ─────────────────────────────────────────────────────────────────
  {
    ...
    tags: ['nigerian food', 'jollof rice', 'egusi', 'pounded yam', 'suya', 'small chops', 'buffet', 'catering', 'pepper soup', 'plantain', 'wedding feast'],
    location: 'Ottawa, ON',
    priceRangeFrom: 50,
    priceRangeTo: 120,
    currency: 'CAD',
