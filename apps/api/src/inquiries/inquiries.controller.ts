...
export class InquiriesController {
  ...
  acceptQuote(@Request() req: AuthedRequest, @Param('id') id: string, @Body() dto: BookQuoteDto) {
  ...
  rejectQuote(@Request() req: AuthedRequest, @Param('id') id: string, @Body() dto: BookQuoteDto) {
    return this.inquiriesService.rejectQuote(req.userId, id, dto.messageId)
  }

  /** Host confirms they booked the person outside Djanora. */
  @Post(':id/book')
  bookQuote(@Request() req: AuthedRequest, @Param('id') id: string, @Body() dto: BookQuoteDto) {
  ...
  markMessagesRead(@Request() req: AuthedRequest, @Param('id') id: string) {
  ...
  @Get('event/:eventId')
  getForEvent(@Request() req: AuthedRequest, @Param('eventId') eventId: string) {
