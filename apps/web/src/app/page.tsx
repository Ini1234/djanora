...
export const metadata: Metadata = {
  ...
  description:
    'CaaS helps Nigerian diaspora couples in Ottawa plan culturally authentic weddings. Find vetted vendors — caterers, DJs, photographers, decorators — all within your budget.',
}
...
const features = [
  ...
  },
  {
    ...
    description:
      'Every vendor on CaaS is Ottawa-based, reviewed by the community, and culturally experienced.',
  },
  {
    icon: CalendarDays,
        ...
        >
          ...
          <div className="relative max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-[var(--color-muted)] max-w-2xl mx-auto mb-10 leading-relaxed">
              CaaS helps Nigerian diaspora couples in Ottawa plan culturally authentic weddings —
