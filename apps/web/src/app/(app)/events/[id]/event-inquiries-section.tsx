              ...
              return (
                <li key={inq.id}>
                  ...
                  >
                    ...
                    <div
                      className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl text-[12px] font-bold"
                      style={{
                        background:
                  ...
                  {/* Vendor profile link */}
                  {inq.vendorProfile && (
                    <div className="-mt-1 px-5 pb-2.5">
                      <Link
